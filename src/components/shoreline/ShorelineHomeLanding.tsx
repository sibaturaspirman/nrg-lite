...
export function ShorelineHomeLanding() {
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      if (e.key === "Enter") {
        e.preventDefault();
        shorelinePush("/shoreline/tnc");
      }
    };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={() => shorelinePush("/shoreline/tnc")}
        ...
        >
          ...
          <Image
            src="/images/shoreline/btn-ready.png"
            alt="Click to begin"
            width={900}
            height={180}
            priority
