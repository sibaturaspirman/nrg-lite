...
type Tab = "preview" | "print";

const TABS: { id: Tab; label: string }[] = [
  { id: "preview", label: "Preview" },
  { id: "print", label: "Print A5" },
];
...
const FIELDS: {
  ...
  { key: "cellW", label: "Lebar foto", min: 0.2, max: 0.5, step: 0.005 },
  { key: "cellH", label: "Tinggi foto", min: 0.15, max: 0.4, step: 0.005 },
  { key: "gapX", label: "Gap X", min: 0, max: 0.1, step: 0.002 },
  { key: "gapY", label: "Gap Y", min: 0, max: 0.1, step: 0.002 },
];
...
export function ShorelineLayoutSettings({ layouts, onChange }: Props) {
    ...
    <>
      ...
      {open && (
        ...
        >
          <div
            role="dialog"
            aria-label="Pengaturan posisi foto 1–4"
