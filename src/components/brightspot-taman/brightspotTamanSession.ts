...
const SHOTS_KEY = "brightspotTamanShots";
const PHOTO_KEY = "brightspotTamanShot";
const PRINT_KEY = "brightspotTamanPrint";

let shotsMemory: string[] | null = null;
let photoMemory: string | null = null;
let printMemory: string | null = null;

export function setBrightspotTamanShots(shots: string[]) {
  shotsMemory = shots;
  try {
...
export function getBrightspotTamanShots(): string[] | null {
  if (
    shotsMemory &&
...
export function clearBrightspotTamanShots() {
  shotsMemory = null;
  try {
    sessionStorage.removeItem(SHOTS_KEY);
  } catch {
...
export function setBrightspotTamanPhoto(dataUrl: string) {
  photoMemory = dataUrl;
  try {
...
export function getBrightspotTamanPhoto(): string | null {
...
export function setBrightspotTamanPrint(dataUrl: string) {
  printMemory = dataUrl;
  try {
...
export function getBrightspotTamanPrint(): string | null {
...
export function clearBrightspotTamanPrintArtifacts() {
  printMemory = null;
  try {
    sessionStorage.removeItem(PRINT_KEY);
  } catch {
