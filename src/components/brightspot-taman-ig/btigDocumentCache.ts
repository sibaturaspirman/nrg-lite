import { BTIG_ROUTES } from "@/app/btig-sw-routes";

const NAV_CACHE = "btig-navigations";
 ...
 */
export async function persistBtigDocuments(): Promise<void> {
