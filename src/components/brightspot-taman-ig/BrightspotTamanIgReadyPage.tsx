...
export function BrightspotTamanIgReadyPage() {
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      if (e.key === "Enter") {
        e.preventDefault();
        btigPush("/brightspot-taman-ig/booth");
      }
    };
  ...
  return (
    <div className="flex min-h-[100dvh] w-full items-center justify-center overflow-hidden bg-black">
      ...
      >
        ...
        <button
          type="button"
          onClick={() => btigPush("/brightspot-taman-ig/booth")}
        ...
        >
          <Image
            src="/images/bt/ready-moment.png"
            alt="Ready — tap to continue"
            width={1080}
            height={1600}
            priority
