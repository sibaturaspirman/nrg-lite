...
// Camera fills the full 1200x1803 output canvas; the overlay frame defines the
...
// Output (composite) ratio matches the frame artwork (1200x1803).
const OUTPUT_W = 1200;
const OUTPUT_H = 1803;
...
const FRAME_OPTIONS = ["/images/Z-TM1.png", "/images/Z-TM2.png"] as const;
...
export function Photobooth() {
  ...
  return (
    <div className="flex min-h-[100dvh] w-full items-center justify-center overflow-hidden bg-black">
      <div
        className="relative mx-auto h-[min(100dvh,calc(100vw*1803/1200))] w-[min(100vw,calc(100dvh*1200/1803))] [container-type:inline-size] mt-[-7rem]"
        style={{ aspectRatio: "1200 / 1803" }}
      >
